...
// ============================================
// YOUTUBE TRANSCRIPT - FIXED VERSION
// ============================================
app.post('/api/youtube-transcript', async (req, res) => {
    try {
        ...
        console.log("🎬 YouTube request for:", url);
        ...
        try {
            ...
            console.log("English captions not found, trying auto-generated...");
            try {
                // Try auto-generated
                transcript = await getSubtitles({ videoID: videoId, lang: 'en', autoGenerated: true });
                usedLang = 'en (auto-generated)';
            } catch (e2) {
                console.log("English failed, trying original language...");
                try {
                    // Try original language
                    transcript = await getSubtitles({ videoID: videoId });
                    usedLang = 'original';
                } catch (e3) {
        ...
        console.log(`✅ Got ${transcript.length} caption segments using ${usedLang}`);
        ...
        if (req.body.checkOnly) {
            return res.json({ 
                has_captions: false, 
                message: "No captions available for this video. Try a different video."
            });
        }
